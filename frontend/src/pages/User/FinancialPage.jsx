    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-zinc-50">
      <div className="max-w-7xl mx-auto px-6 py-8">
              ...
              {companySettings?.company_logo_url ? (
                <div className="relative">
                  ...
                  <img 
                    ...
                    alt="Company Logo" 
                    className="relative h-14 w-14 object-contain rounded-xl bg-white p-2 shadow-md"
                  />
                </div>
              ) : (
                <div className="w-14 h-14 bg-gradient-to-br from-slate-700 to-slate-600 rounded-xl flex items-center justify-center shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          {/* Total Revenue */}
          <div className="bg-gradient-to-br from-indigo-400/90 to-indigo-500/90 rounded-2xl shadow-lg hover:shadow-xl p-6 text-white transform hover:scale-[1.02] transition-all duration-300 border border-indigo-300/20">
            ...
            <p className="text-3xl font-bold mb-2">{formatCurrency(financialSummary.total_revenue)}</p>
            <p className="text-xs opacity-75">Total nilai booking</p>
          </div>

          {/* Total Received */}
          <div className="bg-gradient-to-br from-emerald-400/90 to-teal-500/90 rounded-2xl shadow-lg hover:shadow-xl p-6 text-white transform hover:scale-[1.02] transition-all duration-300 border border-emerald-300/20">
            <div className="flex items-center justify-between mb-4">
              <div className="bg-white/20 backdrop-blur-sm rounded-xl p-3">
            ...
            <h3 className="text-sm font-medium opacity-90 mb-1">Sudah Diterima</h3>
            <p className="text-3xl font-bold mb-2">{formatCurrency(financialSummary.total_paid)}</p>
            <p className="text-xs opacity-75">Dana yang sudah masuk</p>
          </div>

          {/* Total Unpaid */}
          <div className="bg-gradient-to-br from-amber-400/90 to-orange-400/90 rounded-2xl shadow-lg hover:shadow-xl p-6 text-white transform hover:scale-[1.02] transition-all duration-300 border border-amber-300/20">
            <div className="flex items-center justify-between mb-4">
              <div className="bg-white/20 backdrop-blur-sm rounded-xl p-3">
                <FiClock className="w-6 h-6" />
              </div>
              <FiAlertCircle className="w-5 h-5 opacity-80" />
            </div>
            <h3 className="text-sm font-medium opacity-90 mb-1">Belum Dibayar</h3>
            <p className="text-3xl font-bold mb-2">{formatCurrency(financialSummary.total_unpaid)}</p>
            <p className="text-xs opacity-75">Sisa tagihan</p>
          </div>

          {/* Total Expenses */}
          <div className="bg-gradient-to-br from-rose-400/90 to-pink-500/90 rounded-2xl shadow-lg hover:shadow-xl p-6 text-white transform hover:scale-[1.02] transition-all duration-300 border border-rose-300/20">
            <div className="flex items-center justify-between mb-4">
              <div className="bg-white/20 backdrop-blur-sm rounded-xl p-3">
            ...
            <h3 className="text-sm font-medium opacity-90 mb-1">Total Pengeluaran</h3>
            <p className="text-3xl font-bold mb-2">{formatCurrency(financialSummary.total_expenses)}</p>
          ...
          <div className={`bg-gradient-to-br ${
          ...
          } rounded-2xl shadow-lg hover:shadow-xl p-6 text-white transform hover:scale-[1.02] transition-all duration-300 border`}>
            <div className="flex items-center justify-between mb-4">
              <div className="bg-white/20 backdrop-blur-sm rounded-xl p-3">
            ...
            <h3 className="text-sm font-medium opacity-90 mb-1">Pendapatan Bersih</h3>
            <p className="text-3xl font-bold mb-2">{formatCurrency(financialSummary.net_income)}</p>
            <p className="text-xs opacity-75">Diterima - Pengeluaran</p>
          </div>

          {/* Payment Status Summary */}
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl p-6 border border-gray-200/50">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-bold text-slate-700">Status Pembayaran</h3>
              <FiBarChart2 className="w-5 h-5 text-slate-400" />
            </div>
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 bg-gradient-to-r from-amber-50/80 to-yellow-50/80 rounded-xl border border-amber-200/30">
                <span className="text-sm font-medium text-slate-700">Belum Bayar</span>
                <span className="text-lg font-bold text-amber-600">{stats.unpaid}</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-gradient-to-r from-orange-50/80 to-amber-50/80 rounded-xl border border-orange-200/30">
                <span className="text-sm font-medium text-slate-700">Down Payment</span>
                <span className="text-lg font-bold text-orange-600">{stats.down_payment}</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-gradient-to-r from-emerald-50/80 to-teal-50/80 rounded-xl border border-emerald-200/30">
                <span className="text-sm font-medium text-slate-700">Lunas</span>
                <span className="text-lg font-bold text-emerald-600">{stats.paid}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200/50 p-6 mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-slate-500 mt-1">Kelola semua pengeluaran perusahaan</p>
            </div>
            <div className="flex gap-3">
              <button
                ...
                className="px-4 py-2.5 bg-gradient-to-r from-violet-500 to-purple-500 text-white rounded-xl hover:shadow-lg hover:shadow-violet-500/30 transition-all flex items-center gap-2 font-semibold transform hover:scale-105 duration-200"
              >
              ...
              <button
                ...
                className="px-4 py-2.5 bg-gradient-to-r from-indigo-500 to-indigo-600 text-white rounded-xl hover:shadow-lg hover:shadow-indigo-500/30 transition-all flex items-center gap-2 font-semibold transform hover:scale-105 duration-200"
              >
                <FiPlus className="w-5 h-5" />
                Tambah Pengeluaran
              </button>
          ...
          <div className="mb-6 space-y-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-400 focus:border-transparent bg-white text-slate-700 transition-all"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div>
                <label className="block text-sm font-medium text-slate-600 mb-2">Bulan</label>
                <select
                  value={filterMonth}
              ...
              <div>
                <label className="block text-sm font-medium text-slate-600 mb-2">Tahun</label>
                <select
                  value={filterYear}
          ...
          {/* Expenses Table */}
          <div className="overflow-x-auto rounded-xl border border-slate-200/50 shadow-sm max-h-[500px] overflow-y-auto">
            <table className="w-full">
              <thead className="bg-gradient-to-r from-slate-50/80 to-zinc-50/80 backdrop-blur-sm">
                <tr>
                  <th className="px-6 py-4 text-left text-xs font-bold text-slate-600 uppercase tracking-wider">Tanggal</th>
                  <th className="px-6 py-4 text-left text-xs font-bold text-slate-600 uppercase tracking-wider">Kategori</th>
                  <th className="px-6 py-4 text-left text-xs font-bold text-slate-600 uppercase tracking-wider">Deskripsi</th>
                  <th className="px-6 py-4 text-right text-xs font-bold text-slate-600 uppercase tracking-wider">Jumlah</th>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-slate-200/50">
            ...
            {expensesByCategory.length > 0 ? (
              ...
              <div className="h-64 flex items-center justify-center text-slate-400">
                <div className="text-center">
                  <FiPieChart className="w-16 h-16 mx-auto mb-3 opacity-30" />
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-slate-200/50">
            ...
            <div className="space-y-2 max-h-80 overflow-y-auto">
              {categories.map((category) => (
                <div
                  key={category.id}
                  className="flex items-center justify-between p-3 rounded-xl border border-slate-200 hover:shadow-md hover:border-slate-300 transition-all bg-gradient-to-r from-white/80 to-slate-50/50"
          ...
          <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-slate-200">
            ...
            <form onSubmit={handleSaveExpense} className="p-6 space-y-6">
              <div className="relative category-dropdown-container">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-400 focus:border-transparent bg-white text-slate-700 transition-all"
                  />
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  className="flex-1 px-6 py-3 bg-gradient-to-r from-indigo-500 to-indigo-600 text-white rounded-xl hover:shadow-lg hover:shadow-indigo-500/30 transition-all font-semibold"
                >
      ...
      {showCategoryModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl max-w-md w-full border border-slate-200">
            <div className="bg-gradient-to-r from-violet-500 to-purple-500 text-white p-6 rounded-t-2xl">
              <div className="flex items-center justify-between">
                <h3 className="text-2xl font-bold">
            ...
            <form onSubmit={handleSaveCategory} className="p-6 space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-violet-400 focus:border-transparent bg-white text-slate-700 transition-all"
                ...
                <div className="grid grid-cols-7 gap-2">
                  {iconOptions.map(icon => (
                    <button
                      ...
                      className={`p-3 text-2xl rounded-xl transition-all hover:bg-slate-100 ${
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  className="flex-1 px-6 py-3 bg-gradient-to-r from-violet-500 to-purple-500 text-white rounded-xl hover:shadow-lg hover:shadow-violet-500/30 transition-all font-semibold"
                >
